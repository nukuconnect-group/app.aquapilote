      ...
      <Card className="w-full max-w-2xl mx-auto shadow-2xl">
        <CardContent className="p-0">
          <div className={`${slides[currentSlide].bgColor} p-8 sm:p-12 text-center transition-all duration-300`}>
            ...
            <div className="mb-6">
              <img src={slides[currentSlide].image} alt={slides[currentSlide].title} className="w-full max-w-md mx-auto rounded-lg shadow-lg" />
            </div>
            ...
            <div className="flex justify-between items-center mb-8">
              <Button variant="ghost" onClick={prevSlide} disabled={currentSlide === 0} className="flex items-center gap-2 text-sm sm:text-base">
              ...
              <Button variant="ghost" onClick={nextSlide} disabled={currentSlide === slides.length - 1} className="flex items-center gap-2 text-sm sm:text-base">
            ...
            {currentSlide === slides.length - 1 && <div className="space-y-4 w-full">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full max-w-lg mx-auto px-4">
              <Button onClick={() => {
                onComplete();
                onRegister();
              }} className="bg-gradient-aqua px-6 sm:px-8 py-2.5 sm:py-3 text-base sm:text-lg font-semibold hover:opacity-90 transition-opacity w-full sm:w-auto text-zinc-700">
                Créer un compte
              </Button>
